...
ORIGINAL_ACTIVITIES = {
    ...
    "Basketball Team": {
        "description": "Team-based sport training and competitive games",
        "schedule": "Mondays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["tyler@mergington.edu", "julia@mergington.edu"]
    },
    "Swimming Club": {
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and performance rehearsals",
    ...
    "Debate Team": {
        "description": "Prepare for debate competitions and public speaking",
